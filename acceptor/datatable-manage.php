...
$sql="select * from tbl_donations where ngoid='$id'";
$re=$conn->query($sql);
...
$phone=$row1['phone'];
    ...
    <tr>                                            <input type="hidden" value="<?php echo $did;?> " name="rid"/>
                                                        ...
                                                        if($vstatus=="2")
                                                        {
                                                           echo ' <span class="badge bg-danger-transparent rounded-pill text-danger p-2 px-3">Rejected by you</span>';
                                                        }
