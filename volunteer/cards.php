<?php
$tcount=0;$pcount=0;$ccount=0;
$sql="select count(*) as d_count from tbl_donations where volid='".$id."'";
if($re=$conn->query($sql)){
if($row=mysqli_fetch_array($re))
$tcount=$row['d_count'];
}
$sql="select count(*) as vol_count from tbl_donations where volid='".$id."' and volstatus=0";
if($re=$conn->query($sql)){
if($row=mysqli_fetch_array($re))
$pcount=$row['vol_count'];
}

$sql="select count(*) as n_count from tbl_donations where volid='".$id."'  and volstatus=1";
if($re=$conn->query($sql)){
if($row=mysqli_fetch_array($re))
$ccount=$row['n_count'];}
?>
